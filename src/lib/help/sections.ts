...
export const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Assigning the week', text: 'Names sit in fixed columns: the same person is in the same spot on the This week row and on every day, and the columns stretch across the whole sheet so nothing is squeezed or ragged. Tap a name chip on a day to put that person on it, tap again to remove. Press and drag a chip down across days to fill several at once, spreadsheet-style. The "This week" row toggles someone onto all 7 days at once. Everything saves automatically.' },
