...
export const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Assigning the week', text: 'Each job shows only the people on it: one column per person, days down the side, the same way the emailed schedule reads. Add person lists the rest of the crew, and picking someone puts them on the days the job already runs (Monday to Friday on an empty job). Tap a cell to put someone on a day or take them off it, press and drag down a column to fill several days, and the name chip at the top of a column toggles all seven; the small × on that chip takes them off the job entirely. Tap a name chip on a day to put that person on it, tap again to remove. Press and drag a chip down across days to fill several at once, spreadsheet-style. The "This week" row toggles someone onto all 7 days at once. Everything saves automatically.' },
