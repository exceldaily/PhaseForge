...
export const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Job numbers on cards', text: 'Every project card on a board shows its Job# in a small blue tag, at every card size, so the number the office and the field both use is always on the card. It comes from the Job # field on the project.' },
