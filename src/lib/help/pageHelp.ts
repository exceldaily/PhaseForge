...
export const PAGE_HELP: PageHelp[] = [
  ...
  },
  {
    ...
    pins: [
      ...
      { key: 'sched-print', label: 'Print / PDF', text: 'Opens a checklist of this week\u2019s jobs, all ticked. Untick the ones you want left off, then print. The yellow times box and long job names print in full.' },
