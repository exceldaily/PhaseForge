...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Quick access from the board', text: 'Each project can show a Punch List button right on its board card (with open / done counts) for one-tap access. Toggle it per project in the Details section of the project form.' },
