...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      { heading: 'Command Center', text: 'Every open service call, auto-ranked by what needs attention first. Smart section chips slice the queue instantly: New Needs Review, Needs Dispatch Now, No Tech, Missing ETA, Follow-Up, Parts Received, Proposal Approved, Scheduled Today/Tomorrow, Aging, Recently Completed. Sort by smart priority or ETA, search and filter by customer, store, status, urgency, tech, part/proposal status, or date range.' },
