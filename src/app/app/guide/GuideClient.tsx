...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Transfer to board', text: 'Move a project onto any board at any time: open the project, choose "Transfer to Board" from the ⋯ menu, pick the board and which stage to land in, and confirm. The same dialog moves it between stages, transfers it to a different board, or removes it from boards entirely. The project keeps all of its data — the board card simply shows whatever fields that board is configured to display.' },
