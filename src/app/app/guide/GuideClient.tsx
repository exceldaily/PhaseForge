...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Creating a call', text: 'New Call needs a customer or a store, either one works, so customers without store locations are fine. It captures the customer\'s Service Call # with an optional tracking link, your own internal Job #, urgency or the customer\'s priority level (P1, P2…), dates, an ETA with an optional exact time, assigned tech, equipment, NTE dollar cap, part and proposal status, manager note, and description.' },
