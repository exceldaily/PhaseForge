...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: 'Managing & deleting drawings', text: 'Use Select on the Plans page to bulk tag, change discipline, archive, or (owners/admins) permanently delete drawings with the floating action bar. A single sheet can also be deleted from the viewer: open its info panel and use "Delete sheet & all revisions" at the bottom — deletion removes every revision and its files and cannot be undone, so archiving is usually the safer choice.' },
    ],
  },
  {
    id: 'gantt',
